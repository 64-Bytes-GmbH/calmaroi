"""
Django settings for calmaroi project.
...
if not DEBUG:
    LOGGING = {
        ...
        'handlers': {
            'db_log': {
                'level': 'DEBUG',
                'class': 'custom_logger.db_log_handler.DatabaseLogHandler'
            },
        },
        'loggers': {
            'db': {
...
WSGI_APPLICATION = 'calmaroi.wsgi.application'
